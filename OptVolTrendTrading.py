...
class CVolTrendTradingStrategy(object):
    ...
    def do_position(self, trading_datetime, opt_type, capital):
        """
        进行建仓操作
        :param trading_datetime: 交易时间
        ...
        # 3.计算平值期权、虚值期权的建仓数量
        funit_cost = atm_opt.quote_1min.ix[trading_datetime, 'close'] * atm_opt.multiplier * atm_ratio + otm_opt.margin * otm_ratio
        num_of_units = int(round(capital / funit_cost, 0))
